    ...
    n) {
        ...
        n.extend(h.prototype, {
            init: function() {
                ...
                i.remove()),
                n("head").append('<style id="fancybox-style-noscroll" type="text/css">.compensate-for-scrollbar { padding-right: ' + d + "px; }</style>"),
...
!function(e) {
    ...
    function i(l) {
        ...
        return e[l].call(n.exports, n, n.exports, i), n.l = !0, n.exports;
    }
    i.m = e, i.c = t, i.d = function(e, t, l) {
        ...
        if (i.r(l), Object.defineProperty(l, "default", {
            enumerable: !0,
            value: e
        }), 2 & t && "string" != typeof e) for (var n in e) i.d(l, n, function(t) {
            return e[t];
        }.bind(null, n));
        return l;
    }, i.n = function(e) {
    ...
    var s, a = {
        ...
        this.popup = n()(e.popupRender.replace("{privacy}", e.privacy)).appendTo("body"), 
        this.overlay = n()(e.overlayRender).appendTo("body"), this.checkbox = null;
        var t = this;
        this.popup.find(".confirm").click(function() {
            t.checkbox.prop("checked", !0), t.checkbox.change(), t.hide();
        });
    };
    n.a.extend(r.prototype, {
        show: function(e) {
    ...
    var o = function(e, t, i) {
        this.elem = e, this.rules = t, this.validator = i, this.opts = i.opts, this.value = null, 
        this.oldValue = "", this.rules && (this.erElem = null, this.tipElem = null, this.required = -1 !== t.indexOf("required")), 
        this.$placeholder = null, n()(this.elem).siblings("label").length && (this.$placeholder = n()(this.elem).siblings("label"));
        var l = !0;
        Object.defineProperty(this, "valid", {
            ...
            set: function(e) {
                e !== l && (l = e, this.validator._checkButtons());
            }
        }), this._validate(!0);
        var s = this;
        this.rules && (e.on("change completed", function() {
            ...
            s._tip(!0);
        })), t && ~t.indexOf("valid_phone") && e.on("input", function() {
            s._transformToPhone();
        }), this.$placeholder && (s._placeholder(), e.on("focusin input", function() {
            s._placeholder("remove");
        }), e.on("focusout", function() {
            s._placeholder("enable");
        }));
    };
    n.a.extend(o.prototype, {
        _validate: function(e) {
            if (e = e || !1, !this.rules) return !0;
            if ("stopvalidation" === this.elem.attr("data-validation")) return this.valid = !0, 
            this.value = null, this._removeError(), !0;
            if (this.value !== this.elem.val() || !e) {
                var t, i, l = this.rules.split("|"), n = !this.elem.val(), s = [];
                for (this.value = this.elem.val(), t = 0, i = l.length; t < i; t++) {
                    var a = l[t], r = null, o = !1, h = this.opts.ruleRegex.exec(a);
                    if (n && !this.required) break;
                    if ((!n || -1 !== [ "required", "agreement" ].indexOf(a)) && (h && (a = h[1], r = h[2]), 
                    "!" === a.charAt(0) && (a = a.substring(1, a.length)), "function" == typeof this._hooks[a] && (this._hooks[a].apply(this, [ r ]) || (o = !0)), 
                    o)) {
                        var u = this.elem.data(a);
                        u || (u = this.opts.messages[a]), r && (u = u.replace("%s", r)), s.push(u);
                    }
                }
                return s.length ? (e || this._setError(s), this.valid = !1, this.elem.attr("data-validation", "invalid")) : (this._removeError(), 
                this.valid = !0, this.elem.attr("data-validation", "valid")), this.valid;
            }
        },
        _testInput: function() {
            this.value = this.elem.val(), this._hooks.alpha.apply(this) ? (this.oldValue = this.value, 
            this._tip(!0)) : (this.elem.val(this.oldValue), this._tip());
        },
        _tip: function(e) {
            e = e || !1;
            var t = this.opts.messages.alpha;
            e ? this.tipElem && (this.tipElem.remove(), this.tipElem = null) : this.tipElem || (this.tipElem = n()('<span class="message-tooltip">' + t + "</span>").insertAfter(this.elem));
        },
        _transformToPhone: function() {
            var e = this.elem.val();
            if (e) if ((e = e.replace(/\D/g, "")).length) {
                "3" !== e[0] && "8" !== e[0] || (e = e.slice(2));
                var t = "+38(", i = [ e.slice(0, 3), e.slice(3, 6), e.slice(6, 8), e.slice(8, 10) ];
        ...
        _placeholder: function(e) {
            var t = !this.elem.val();
            e = e || "enable", this.opts.hideLabels && ("enable" === e ? t && this.$placeholder.removeClass("label-none") : this.$placeholder.addClass("label-none"));
        },
        _setError: function(e) {
            this.erElem ? this.erElem.html(e.join(" ")) : -1 === this.rules.indexOf("agreement") && (this.erElem = n()('<span class="message-error">' + e.join(" ") + "</span>").insertAfter(this.elem)), 
            this.elem.addClass("error"), this.elem.removeClass("correctly");
        },
        _removeError: function() {
            this.erElem && (this.erElem.remove(), this.erElem = null, this.elem.addClass("correctly"), 
        ...
        _hooks: {
            ...
            agreement: function() {
                ...
                if ("checkbox" === t || "radio" === t) {
                    ...
                    return i || (e = this.opts, s || (s = new r(e)), s).show(this.elem), i;
                }
                return !!this.value;
            }
        }
    ...
    var h = o, u = function(e, t) {
        ...
        for (var i = 0; i < e.elements.length; i++) if ("submit" !== e.elements[i].type) {
            var l = n()(e.elements[i]), s = this._genElemRules(l);
            s.length ? this.fields.push(new h(l, s.join("|"), this)) : this.fields.push(new h(l, null, this));
        } else this.buttons.push(e.elements[i]);
        this._checkButtons(), n()(e).submit(n.a.proxy(this, "_validateForm"));
    };
    n.a.extend(u.prototype, {
        _genElemRules: function(e) {
            for (var t = {}, i = [], l = 0; l < this.allRules.length; l++) e.is(this.allRules[l].el) && (t[this.allRules[l].rule] = !0);
        ...
        _validateForm: function(e) {
            ...
            return t && (e && e.preventDefault ? e.preventDefault() : event && (event.returnValue = !1)), 
            !0;
        },
    ...
    var c = u;
    !function() {
        if (n()("label.agreement-label .check").click(function(e) {
            e.preventDefault();
            var t = n()(this).siblings("input"), i = !t.prop("checked");
            t.prop("checked", i), t.change();
        }), n.a.fancybox) {
            var e = n.a.fancybox.defaults.clickContent;
            n.a.fancybox.defaults.clickContent = function(t, i) {
                t.$content[0].contains(document.activeElement) && document.activeElement.blur(), 
                e(t, i);
            };
        }
    }(), n.a.fn.validate = function(e) {
        if (this.length) return e = n.a.extend(!0, {}, a, e), this.each(function() {
            var t = n()(this).data("validator");
            t || (n()(this).find("span.add-textarea").click(function() {
                n()(this).toggleClass("opened");
            }), t = new c(this, e), n()(this).data("validator", t));
        }), this;
    };
} ]);
$( document ).ready(function() {
