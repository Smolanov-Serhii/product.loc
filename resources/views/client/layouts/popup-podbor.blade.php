    ...
    <div class="form form-style-1 hideLabels">
        <div class="form-head">
            <div class="form-header animate-top">
                Заказать копирование сайта
            </div>
            <div class="form-desk animate-top">
                Оставьте свой номер - наш специалист перезвонит в течение 15 минут (в рабочее время)
            </div>
        </div>
        <form id="auto_select_order" action="send.php" onsubmit="call($(this).attr('id'))" method="post" class="form_block">
            <input type="hidden" name="type" value="Заказать сайт">
