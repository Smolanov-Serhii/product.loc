    ...
    <div class="card-body">
        <div class="tab-content" id="custom-tabs-one-tabContent">
            ...
            <div class="tab-pane fade" id="custom-tabs-two-profile" role="tabpanel"
                ...
                @include('admin.additions.includes.create_update_form', [$lang = \App\Models\Language::where('id',3)->first(), $model = $module_item])
            </div>
            <div class="tab-pane fade" id="custom-tabs-three-profile" role="tabpanel"
                 aria-labelledby="custom-tabs-three-profile-tab">
                @include('admin.seo.includes.create_update_form', [$lang = \App\Models\Language::where('id',3)->first(), $model = $module_item])
            </div>
